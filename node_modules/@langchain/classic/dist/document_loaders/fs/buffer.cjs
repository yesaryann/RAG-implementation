...
var buffer_exports = /* @__PURE__ */ require_runtime.__exportAll({ BufferLoader: () => BufferLoader });
/**
...
*/
var BufferLoader = class BufferLoader extends _langchain_core_document_loaders_base.BaseDocumentLoader {
	filePathOrBlob;
