	...
	parseAIMessage(message) {
		...
		if (message.additional_kwargs.tool_calls) {
			...
			try {
				...
				throw new _langchain_core_output_parsers.OutputParserException(`Failed to parse tool arguments from chat model response. Text: "${JSON.stringify(toolCalls)}". ${error}`);
			}
		} else return {
