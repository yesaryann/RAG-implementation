	...
	*/
	...
	_generate_numbered_list(items, item_type = "list") {
		if (item_type === "command") {
			...
			const finish_string = `${items.length + 1}. ${require_schema.FINISH_NAME}: use this to signal that you have finished all your objectives, args: "response": "final response to let people know you have finished your objectives"`;
