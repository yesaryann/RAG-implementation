...
var WebBrowser = class extends Tool {
	...
	async _call(inputs, runManager) {
		...
		if (doSummary) context = texts.slice(0, 4).join("\n");
			...
			context = formatDocumentsAsString(await (await MemoryVectorStore.fromDocuments(docs, this.embeddings)).similaritySearch(task, 4, void 0, runManager?.getChild("vectorstore")));
		}
