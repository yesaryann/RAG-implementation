...
class WatsonxBaseService extends ibm_cloud_sdk_core_1.BaseService {
    ...
    constructor(options = {}) {
        ...
        if (!options.version) {
            options.version = version_1.VERSION_DATE;
        }
        ...
        (0, validators_1.validateRequiredOneOf)(options, ['projectId', 'spaceId'], false);
...
WatsonxBaseService.PLATFORM_URLS_MAP = config_1.PLATFORM_URL_MAPPINGS;
/**
...
class APIBaseService extends WatsonxBaseService {
    ...
    _formContainerIdHeaders(params = {}, requireContainerId = false) {
        ...
        if (requireContainerId)
            (0, validators_1.validateRequiredOneOf)({ projectId, spaceId }, ['projectId', 'spaceId']);
