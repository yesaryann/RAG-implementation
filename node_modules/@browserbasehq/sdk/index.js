...
const certificates_1 = require("./resources/certificates.js");
...
class Browserbase extends Core.APIClient {
    ...
    constructor({ baseURL = Core.readEnv('BROWSERBASE_BASE_URL'), apiKey = Core.readEnv('BROWSERBASE_API_KEY'), ...opts } = {}) {
        ...
        this.certificates = new API.Certificates(this);
...
Browserbase.Certificates = certificates_1.Certificates;
...
Browserbase.Search = search_1.Search;
Browserbase.Sessions = sessions_1.Sessions;
Browserbase.Agents = agents_1.Agents;
