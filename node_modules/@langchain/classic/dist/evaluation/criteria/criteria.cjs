...
var CriteriaEvalChain = class extends require_base.LLMStringEvaluator {
	...
	*/
	static resolvePrompt(prompt) {
		...
		if (!require_base.eqSet(expectedInputVars, new Set(_prompt.inputVariables))) throw new Error(`Input variables should be ${[...expectedInputVars]}, but got ${_prompt.inputVariables}`);
		return _prompt;
	}
	/**
