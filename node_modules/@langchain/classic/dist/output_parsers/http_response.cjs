...
*/
var HttpResponseOutputParser = class extends _langchain_core_output_parsers.BaseTransformOutputParser {
	static lc_name() {
		return "HttpResponseOutputParser";
	}
	lc_namespace = ["langchain", "output_parser"];
	lc_serializable = true;
	outputParser = new _langchain_core_output_parsers.StringOutputParser();
	...
	async *_transform(inputGenerator) {
		...
		if (this.contentType === "text/event-stream") yield new TextEncoder().encode(`event: end\n\n`);
	}
	/**
