...
import { AgentArgs, AgentRunnableSequence, BaseSingleActionAgent } from "../agent.cjs";
import { XMLAgentOutputParser } from "./output_parser.cjs";
 ...
 * ```
 */
declare function createXmlAgent({ llm, tools, prompt, streamRunnable }: CreateXmlAgentParams): Promise<AgentRunnableSequence<{
  steps: AgentStep[];
