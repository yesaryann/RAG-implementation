...
var PineconeStore = class PineconeStore extends VectorStore {
	...
	*/
	async maxMarginalRelevanceSearch(query, options) {
		...
		const topMmrMatches = maximalMarginalRelevance(queryEmbedding, matches.map((match) => match.values), options.lambda, options.k).map((idx) => matches[idx]);
