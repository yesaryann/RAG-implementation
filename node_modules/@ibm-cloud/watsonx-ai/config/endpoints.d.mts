...
export declare const BATCH_INFERENCE_ENDPOINTS: {
    readonly BASE: "/ml/v1/batches";
    readonly BY_ID: "/ml/v1/batches/{batch_id}";
    readonly CANCEL_BY_ID: "/ml/v1/batches/{batch_id}/cancel";
};
export declare const FILES_ENDPOINTS: {
    readonly BASE: "/ml/v1/files";
    readonly BY_ID: "/ml/v1/files/{file_id}";
    readonly CONTENT_BY_ID: "/ml/v1/files/{file_id}/content";
};
