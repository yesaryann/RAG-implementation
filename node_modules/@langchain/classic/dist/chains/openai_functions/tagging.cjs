...
function createTaggingChain(schema, llm, options = {}) {
	const { prompt = _langchain_core_prompts.PromptTemplate.fromTemplate(TAGGING_TEMPLATE), ...rest } = options;
...
function createTaggingChainFromZod(schema, llm, options) {
	return createTaggingChain((0, _langchain_core_utils_json_schema.toJsonSchema)(schema), llm, options);
}
//#endregion
