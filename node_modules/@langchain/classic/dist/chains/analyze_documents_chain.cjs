...
var AnalyzeDocumentChain = class AnalyzeDocumentChain extends require_base.BaseChain {
	...
	constructor(fields) {
		...
		this.textSplitter = fields.textSplitter ?? new _langchain_textsplitters.RecursiveCharacterTextSplitter();
	}
	get inputKeys() {
	...
	async _call(values, runManager) {
		...
		const newInputs = {
			input_documents: await this.textSplitter.createDocuments([currentDoc]),
			...rest
		};
		return await this.combineDocumentsChain.call(newInputs, runManager?.getChild("combine_documents"));
	}
	_chainType() {
