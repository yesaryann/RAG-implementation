...
const traceable_js_2 = require("../singletons/traceable.cjs");
...
const getChatModelInvocationParamsFn = (provider, prepopulatedInvocationParams, useResponsesApi) => {
    return (payload) => {
        ...
        const requestMetadata = typeof params.metadata === "object" &&
        ...
        return {
            ...
            ...(0, ls_agent_type_js_1.defaultLsAgentTypeMetadata)(requestMetadata, (0, traceable_js_2.getCurrentRunTree)(true)),
        };
    };
};
/**
        ...
        create: (0, traceable_js_1.traceable)(openai.completions.create.bind(openai.completions), {
            ...
            getInvocationParams: (payload) => {
                ...
                return {
                    ...
                    ...(0, ls_agent_type_js_1.defaultLsAgentTypeMetadata)({}, (0, traceable_js_2.getCurrentRunTree)(true)),
                };
            },
            ...cleanedOptions,
        }),
