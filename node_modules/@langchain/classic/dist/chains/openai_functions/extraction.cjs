...
function createExtractionChain(schema, llm) {
	...
	const prompt = _langchain_core_prompts.PromptTemplate.fromTemplate(_EXTRACTION_TEMPLATE);
...
function createExtractionChainFromZod(schema, llm) {
	return createExtractionChain((0, _langchain_core_utils_json_schema.toJsonSchema)(schema), llm);
}
//#endregion
