...
import { TimeWeightedVectorStoreRetriever } from "../../retrievers/time_weighted.cjs";
import { ChainValues } from "@langchain/core/utils/types";
import { PromptTemplate } from "@langchain/core/prompts";
import { BaseLanguageModelInterface } from "@langchain/core/language_models/base";
import { CallbackManagerForChainRun, Callbacks } from "@langchain/core/callbacks/manager";
import { BaseMemory, InputValues as InputValues$1, OutputValues } from "@langchain/core/memory";
...
declare class GenerativeAgentMemory extends BaseMemory {
   ...
   */
  loadMemoryVariables(inputs: InputValues$1): Promise<Record<string, string>>;
  /**
   ...
   * @returns Nothing.
   */
  saveContext(_inputs: InputValues$1, outputs: OutputValues): Promise<void>;
  /**
...
//#endregion
export { GenerativeAgentMemory, GenerativeAgentMemoryConfig };
//# sourceMappingURL=generative_agent_memory.d.cts.map