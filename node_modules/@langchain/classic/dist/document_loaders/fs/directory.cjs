...
var directory_exports = /* @__PURE__ */ require_runtime.__exportAll({
...
* ```
*/
var DirectoryLoader = class DirectoryLoader extends _langchain_core_document_loaders_base.BaseDocumentLoader {
	directoryPath;
	loaders;
	recursive;
	unknown;
	...
	*/
	static async imports() {
		try {
			...
			console.error(e);
			throw new Error(`Failed to load fs/promises. DirectoryLoader available only on environment 'node'. It appears you are running environment '${(0, _langchain_core_utils_env.getEnv)()}'. See https://<link to docs> for alternatives.`);
		}
	}
};
//#endregion
exports.DirectoryLoader = DirectoryLoader;
exports.UnknownHandling = UnknownHandling;
Object.defineProperty(exports, "directory_exports", {
	enumerable: true,
	get: function() {
		return directory_exports;
	}
});
