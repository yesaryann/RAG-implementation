...
import "../openai/output_parser.cjs";
 ...
 * ```
 */
declare function createOpenAIFunctionsAgent({ llm, tools, prompt, streamRunnable }: CreateOpenAIFunctionsAgentParams): Promise<AgentRunnableSequence<{
  steps: AgentStep[];
