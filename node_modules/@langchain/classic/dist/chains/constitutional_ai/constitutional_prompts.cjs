...
const critiqueExample = /* #__PURE__ */ new _langchain_core_prompts.PromptTemplate({
...
const CRITIQUE_PROMPT = /* #__PURE__ */ new _langchain_core_prompts.FewShotPromptTemplate({
...
const REVISION_PROMPT = /* #__PURE__ */ new _langchain_core_prompts.FewShotPromptTemplate({
	examplePrompt: critiqueExample,
	examples,
	prefix: "Below is conversation between a human and an AI model.",
	suffix: `Human: {input_prompt}
...
exports.critiqueExample = critiqueExample;
