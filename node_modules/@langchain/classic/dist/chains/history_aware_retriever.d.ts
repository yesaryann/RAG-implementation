 ...
 * ```
 */
declare function createHistoryAwareRetriever({ llm, retriever, rephrasePrompt }: CreateHistoryAwareRetrieverParams): Promise<Runnable<{
  input: string;
  chat_history: string | BaseMessage[];
}, DocumentInterface[]>>;
//#endregion
export { CreateHistoryAwareRetrieverParams, createHistoryAwareRetriever };
//# sourceMappingURL=history_aware_retriever.d.ts.map