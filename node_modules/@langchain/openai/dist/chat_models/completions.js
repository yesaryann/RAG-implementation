...
var ChatOpenAICompletions = class extends BaseChatOpenAI {
	...
	async _generate(messages, options, runManager) {
		...
		if (params.stream) {
			...
			if (promptTokensDetails?.audio_tokens !== null || promptTokensDetails?.cached_tokens !== null || promptTokensDetails?.cache_write_tokens != null) usageMetadata.input_token_details = {
				...
				...promptTokensDetails?.cache_write_tokens != null && { cache_creation: promptTokensDetails?.cache_write_tokens }
			};
	...
	async *_streamResponseChunks(messages, options, runManager) {
		...
		if (usage) {
			const inputTokenDetails = {
				...
				...usage.prompt_tokens_details?.cache_write_tokens != null && { cache_creation: usage.prompt_tokens_details?.cache_write_tokens }
			};
