	...
	*/
	async parse(text) {
		...
		try {
			...
			throw new _langchain_core_output_parsers.OutputParserException(`Unable to parse JSON response from chat agent.\n\n${text}`);
		}
	}
	/**
...
exports.FINAL_ANSWER_ACTION = FINAL_ANSWER_ACTION;
