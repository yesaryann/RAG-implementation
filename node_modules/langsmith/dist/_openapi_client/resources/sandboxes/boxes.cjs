...
class Boxes extends resource_js_1.APIResource {
    ...
    retrieve(name, options) {
        return this._client.get((0, path_js_1.path) `/api/v2/sandboxes/boxes/${name}`, options);
    }
    /**
     * Update a sandbox's display name. The name must be unique within the tenant.
     */
    update(name, body, options) {
        return this._client.patch((0, path_js_1.path) `/api/v2/sandboxes/boxes/${name}`, { body, ...options });
    }
    /**
     ...
     */
    delete(name, options) {
        return this._client.delete((0, path_js_1.path) `/api/v2/sandboxes/boxes/${name}`, {
            ...options,
    ...
    createSnapshot(name, body, options) {
        return this._client.post((0, path_js_1.path) `/api/v2/sandboxes/boxes/${name}/snapshot`, { body, ...options });
    }
    /**
    ...
    generateServiceURL(name, body, options) {
        return this._client.post((0, path_js_1.path) `/api/v2/sandboxes/boxes/${name}/service-url`, { body, ...options });
    }
    /**
     * Retrieve the lightweight status of a sandbox for polling.
     */
    getStatus(name, options) {
        return this._client.get((0, path_js_1.path) `/api/v2/sandboxes/boxes/${name}/status`, options);
    }
    /**
     * Start a stopped or failed sandbox. This endpoint is not idempotent.
     */
    start(name, options) {
        return this._client.post((0, path_js_1.path) `/api/v2/sandboxes/boxes/${name}/start`, options);
    }
    /**
     ...
     */
    stop(name, options) {
        return this._client.post((0, path_js_1.path) `/api/v2/sandboxes/boxes/${name}/stop`, {
            ...options,
            headers: (0, headers_js_1.buildHeaders)([{ Accept: '*/*' }, options?.headers]),
        });
    }
