...
var load_exports = /* @__PURE__ */ __exportAll({ loadChain: () => loadChain });
...
const loadChain = async (uri, values = {}) => {
	const hubResult = await loadFromHub(uri, loadChainFromFile, "chains", /* @__PURE__ */ new Set(["json", "yaml"]), values);
