...
import { NON_ROOT_LS_AGENT_TYPES, lsAgentTypeMetadata, resolveDefaultLsAgentType, } from "../../utils/ls_agent_type.js";
...
export function resolveVercelLsAgentType(parentRunTree) {
    const parent = parentRunTree ?? getCurrentRunTree(true);
    if (!isRunTree(parent))
        return resolveDefaultLsAgentType(parent);
...
export function vercelLsAgentTypeMetadata(parentRunTree) {
