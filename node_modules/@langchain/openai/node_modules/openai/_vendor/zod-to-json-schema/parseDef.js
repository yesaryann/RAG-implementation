...
const get$ref = (item, refs) => {
    switch (refs.$refStrategy) {
        ...
        case 'extract-to-root': {
            ...
            const isRootSchema = name === refs.name &&
            ...
            if (!isRootSchema && refs.nameStrategy === 'duplicate-ref') {
                const hasDifferentDefinition = (definitionName) => {
                    if (!(0, values_1.hasOwn)(refs.definitions, definitionName)) {
                        return false;
                    }
                    const existingDefinition = refs.definitions[definitionName];
                    return existingDefinition === undefined || (0, util_1.zodDef)(existingDefinition) !== item.def;
                };
                let suffix = 0;
                ...
                if (!(0, values_1.hasOwn)(refs.definitions, name)) {
