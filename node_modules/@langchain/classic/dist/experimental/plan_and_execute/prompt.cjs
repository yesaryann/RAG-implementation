...
const getPlannerChatPrompt = async (tools) => {
	...
	return /* #__PURE__ */ _langchain_core_prompts.ChatPromptTemplate.fromMessages([_langchain_core_prompts.SystemMessagePromptTemplate.fromTemplate(PLANNER_SYSTEM_PROMPT_MESSAGE_TEMPLATE), _langchain_core_prompts.HumanMessagePromptTemplate.fromTemplate(`{input}`)]).partial({ toolStrings });
};
//#endregion
