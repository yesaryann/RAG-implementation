...
var multi_file_exports = /* @__PURE__ */ require_runtime.__exportAll({ MultiFileLoader: () => MultiFileLoader });
/**
...
* ```
*/
var MultiFileLoader = class extends _langchain_core_document_loaders_base.BaseDocumentLoader {
	filePaths;
	loaders;
	unknown;
