...
exports.validateRequiredOneOf = exports.validateRequestParams = void 0;
...
const validateRequestParams = (params, requiredParams, validParams) => {
    ...
    const validationResult = (0, ibm_cloud_sdk_core_1.validateParams)(params, requiredParams, validParamsWithCommon);
    if (validationResult)
 ...
 */
const validateRequiredOneOf = (params = {}, requiredParams, isAnyRequired = true) => {
