...
var OpenAIAgentTokenBufferMemory = class extends require_memory_chat_memory.BaseChatMemory {
	...
	*/
	async loadMemoryVariables(_values) {
		...
		if (this.returnMessages) return { [this.memoryKey]: buffer };
			...
			const bufferString = (0, _langchain_core_messages.getBufferString)(buffer, this.humanPrefix, this.aiPrefix);
	...
	*/
	async saveContext(inputValues, outputValues) {
		const inputValue = (0, _langchain_core_memory.getInputValue)(inputValues, this.inputKey);
		const outputValue = (0, _langchain_core_memory.getOutputValue)(outputValues, this.outputKey);
