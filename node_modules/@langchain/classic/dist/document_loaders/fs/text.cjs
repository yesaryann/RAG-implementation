...
var text_exports = /* @__PURE__ */ require_runtime.__exportAll({ TextLoader: () => TextLoader });
/**
...
* ```
*/
var TextLoader = class TextLoader extends _langchain_core_document_loaders_base.BaseDocumentLoader {
	filePathOrBlob;
	...
	*/
	async load() {
		...
		return parsed.map((pageContent, i) => new _langchain_core_documents.Document({
			pageContent,
...
Object.defineProperty(exports, "text_exports", {
	enumerable: true,
	get: function() {
		return text_exports;
	}
