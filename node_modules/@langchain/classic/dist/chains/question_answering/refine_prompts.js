...
const messages = [
	...
	/*#__PURE__*/ HumanMessagePromptTemplate.fromTemplate(`The original question is as follows: {question}
We have provided an existing answer: {existing_answer}
We have the opportunity to refine the existing answer
(only if needed) with some more context below.
------------
...
const chat_messages = [/*#__PURE__*/ SystemMessagePromptTemplate.fromTemplate(`Context information is below. 
---------------------
{context}
---------------------
Given the context information and no prior knowledge, answer any questions`), /*#__PURE__*/ HumanMessagePromptTemplate.fromTemplate("{question}")];
...
//#endregion
export { CHAT_QUESTION_PROMPT, CHAT_REFINE_PROMPT, DEFAULT_REFINE_PROMPT, DEFAULT_REFINE_PROMPT_TMPL, DEFAULT_TEXT_QA_PROMPT, DEFAULT_TEXT_QA_PROMPT_TMPL, QUESTION_PROMPT_SELECTOR, REFINE_PROMPT_SELECTOR };
