...
*/
var JsonOutputToolsParser = class extends _langchain_core_output_parsers.BaseLLMOutputParser {
	static lc_name() {
...
* @deprecated Import from "@langchain/core/output_parsers/openai_tools"
*/
var JsonOutputKeyToolsParser = class extends _langchain_core_output_parsers.BaseLLMOutputParser {
	static lc_name() {
	...
	async parseResult(generations) {
		const matchingResults = (await this.initialParser.parseResult(generations)).filter((result) => result.type === this.keyName);
