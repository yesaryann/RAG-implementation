...
var QueryTransformer = class {
	...
	*/
	matchFunctionName(funcName) {
		if (funcName in _langchain_core_structured_query.Comparators) if (this.allowedComparators.length > 0) if (this.allowedComparators.includes(funcName)) return funcName;
		else throw new Error("Received comparator not allowed");
		else return funcName;
		if (funcName in _langchain_core_structured_query.Operators) if (this.allowedOperators.length > 0) if (this.allowedOperators.includes(funcName)) return funcName;
