...
var node_exports = /* @__PURE__ */ __exportAll({ NodeFileStore: () => NodeFileStore });
/**
...
var NodeFileStore = class extends BaseFileStore {
	...
	*/
	async readFile(path) {
		return await fs$1.readFile(join(this.basePath, path), "utf8");
	}
	/**
	...
	*/
	async writeFile(path, contents) {
		await fs$1.writeFile(join(this.basePath, path), contents, "utf8");
	}
};
//#endregion
