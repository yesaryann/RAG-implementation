...
class OnlineEvaluators extends resource_js_1.APIResource {
    ...
    retrieve(evaluatorID, options) {
        return this._client.get((0, path_js_1.path) `/api/v1/platform/evaluators/${evaluatorID}`, options);
    }
    /**
     * Update an existing evaluator's name, LLM configuration, or code configuration.
     */
    update(evaluatorID, body, options) {
        return this._client.patch((0, path_js_1.path) `/api/v1/platform/evaluators/${evaluatorID}`, { body, ...options });
    }
    /**
     ...
     */
    list(query = {}, options) {
        return this._client.getAPIList('/api/v1/platform/evaluators', (pagination_js_1.OffsetPaginationOnlineEvaluators), { query, ...options });
    }
    /**
    ...
    delete(evaluatorID, params = {}, options) {
        ...
        return this._client.delete((0, path_js_1.path) `/api/v1/platform/evaluators/${evaluatorID}`, {
