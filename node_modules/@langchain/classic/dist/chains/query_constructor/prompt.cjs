...
{structured_request}
`;
const EXAMPLE_PROMPT = /* #__PURE__ */ new _langchain_core_prompts.PromptTemplate({
	inputVariables: [
		"i",
		"data_source",
		"user_query",
...
exports.EXAMPLE_PROMPT_TEMPLATE = EXAMPLE_PROMPT_TEMPLATE;
exports.FULL_ANSWER = FULL_ANSWER;
exports.NO_FILTER_ANSWER = NO_FILTER_ANSWER;
exports.SONG_DATA_SOURCE = SONG_DATA_SOURCE;
