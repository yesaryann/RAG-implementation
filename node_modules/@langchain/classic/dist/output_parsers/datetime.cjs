...
*/
var DatetimeOutputParser = class extends _langchain_core_output_parsers.BaseOutputParser {
	static lc_name() {
	...
	*/
	async parse(text) {
		...
		if (Number.isNaN(parsedDate.getTime())) throw new _langchain_core_output_parsers.OutputParserException(`Could not parse output: ${text}`, text);
		return parsedDate;
	}
	/**
