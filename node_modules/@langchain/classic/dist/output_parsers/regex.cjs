...
*/
var RegexParser = class extends _langchain_core_output_parsers.BaseOutputParser {
	static lc_name() {
		return "RegexParser";
	}
	lc_namespace = [
	...
	*/
	async parse(text) {
		...
		if (this.defaultOutputKey === void 0) throw new _langchain_core_output_parsers.OutputParserException(`Could not parse output: ${text}`, text);
