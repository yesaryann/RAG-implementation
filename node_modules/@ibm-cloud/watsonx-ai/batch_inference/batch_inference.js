...
function validateBatchParams(params, requiredParams, validParams) {
    (0, validators_1.validateRequiredOneOf)(params, ['projectId', 'spaceId'], false);
    (0, validators_1.validateRequestParams)(params, requiredParams, validParams);
}
/**
 ...
 */
class BatchInference extends base_1.APIBaseService {
    /**
     ...
     */
    constructor(options) {
        options.authenticator = new ibm_cloud_sdk_core_1.NoAuthAuthenticator(); // batchInference supports different way of authentication, refer to api docs
        const optionsApiKey = options.apikey;
        delete options.apikey;
        super(options);
        _BatchInference_apikey.set(this, void 0);
        const apikey = optionsApiKey !== null && optionsApiKey !== void 0 ? optionsApiKey : (0, ibm_cloud_sdk_core_1.readExternalSources)(options.serviceName).apikey;
        if (!apikey)
    ...
    _get(params) {
        return super._get(this.appendDataToHeaders(params, Object.assign({ 'authorization': `Bearer ${__classPrivateFieldGet(this, _BatchInference_apikey, "f")}` }, this._formContainerIdHeaders(params, true))));
    }
    _post(params) {
        return super._post(this.appendDataToHeaders(params, Object.assign({ 'authorization': `Bearer ${__classPrivateFieldGet(this, _BatchInference_apikey, "f")}` }, this._formContainerIdHeaders(params, true))));
    }
    /**
    ...
    create(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const parameters = {
                url: config_1.ENDPOINTS.BATCH_INFERENCE.BASE,
                body,
    ...
    getDetails(params) {
        return __awaiter(this, void 0, void 0, function* () {
            if ('batchId' in params) {
                ...
                const headers = Object.assign({}, params.headers);
                const parameters = {
                    url: config_1.ENDPOINTS.BATCH_INFERENCE.BY_ID,
    ...
    cancel(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const headers = Object.assign({}, params.headers);
            const parameters = {
                url: config_1.ENDPOINTS.BATCH_INFERENCE.CANCEL_BY_ID,
                path: { batch_id: batchId },
                signal: params.signal,
                headers,
                projectId,
...
//# sourceMappingURL=batch_inference.js.map