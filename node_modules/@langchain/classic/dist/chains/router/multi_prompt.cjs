	...
	*/
	static fromLLMAndPrompts(llm, { promptNames, promptDescriptions, promptTemplates, defaultChain, llmChainOpts, conversationChainOpts, multiRouteChainOpts }) {
		...
		const routerPrompt = new _langchain_core_prompts.PromptTemplate({
			template: (0, _langchain_core_prompts.interpolateFString)(require_multi_prompt_prompt.STRUCTURED_MULTI_PROMPT_ROUTER_TEMPLATE(outputParser.getFormatInstructions({ interpolationDepth: 4 })), { destinations: destinationsStr }),
