...
const require_responses_stream_events = require("./utils/responses_stream_events.cjs");
...
Object.defineProperty(exports, "convertOpenAICompletionsStream", {
	enumerable: true,
	get: function() {
		return _langchain_core_language_models_openai_completions_stream.convertOpenAICompletionsStream;
	}
});
exports.convertOpenAIResponsesStream = require_responses_stream_events.convertOpenAIResponsesStream;
