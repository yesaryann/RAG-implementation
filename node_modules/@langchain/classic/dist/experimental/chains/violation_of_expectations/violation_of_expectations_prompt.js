...
const PREDICTION_VIOLATIONS_PROMPT = /* #__PURE__ */ PromptTemplate.fromTemplate(`You have been given a prediction and an actual message from a human and AI conversation.
...
--------
`);
const GENERATE_REVISED_PREDICTION_PROMPT = /* #__PURE__ */ PromptTemplate.fromTemplate(`
...
Revised Prediction:`);
const GENERATE_FACTS_PROMPT = /* #__PURE__ */ PromptTemplate.fromTemplate(`
