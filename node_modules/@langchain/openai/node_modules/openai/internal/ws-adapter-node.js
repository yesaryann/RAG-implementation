...
class NodeWebSocket {
    ...
    constructor(ws) {
        ...
        this._ws.on('redirect', (_url, request) => {
            try {
                const options = (0, ws_1.protectWebSocketOptionsFromCredentialRedirects)({
    ...
    _registerListener(event, listener, wrapped) {
