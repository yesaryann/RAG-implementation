	...
	*/
	static fromLLM(llm, retriever, options = {}) {
		...
		const questionGeneratorChain = new require_llm_chain.LLMChain({
			prompt: _langchain_core_prompts.PromptTemplate.fromTemplate(questionGeneratorChainOptions?.template ?? questionGeneratorTemplate ?? question_generator_template),
