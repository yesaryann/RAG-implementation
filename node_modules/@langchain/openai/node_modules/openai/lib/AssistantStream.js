...
_AssistantStream_addEvent = function _AssistantStream_addEvent(event) {
    ...
    switch (event.event) {
        ...
        case 'thread.run.step.delta': {
            const snapshot = tslib_1.__classPrivateFieldGet(this, _AssistantStream_runStepSnapshots, "f")[event.data.id];
            if (!snapshot) {
