...
declare function initializeAgentExecutor(tools: ToolInterface[], llm: BaseLanguageModelInterface, _agentType?: AgentType, _verbose?: boolean, _callbackManager?: CallbackManager): Promise<AgentExecutor>;
/**
 * @interface
 */
